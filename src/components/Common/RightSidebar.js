		          ...
		          <div className="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
		            ...
		            <ul className="chat-list">
		              <li className="list active">
		                <div className="profile"><img src="/assets/images/faces/face1.jpg" alt="face1" /><span className="online"></span></div>
		                <div className="info">
		                  <p>Thomas Douglas</p>
		                  <p>Available</p>
		                </div>
		              ...
		              <li className="list">
		                <div className="profile"><img src="/assets/images/faces/face2.jpg" alt="face2" /><span className="offline"></span></div>
		                <div className="info">
		              ...
		              <li className="list">
		                <div className="profile"><img src="/assets/images/faces/face3.jpg" alt="face3" /><span className="online"></span></div>
		                <div className="info">
		                  <p>Daniel Russell</p>
		                  <p>Available</p>
		                </div>
		              ...
		              <li className="list">
		                <div className="profile"><img src="/assets/images/faces/face4.jpg" alt="face4" /><span className="offline"></span></div>
		                <div className="info">
		              ...
		              <li className="list">
		                <div className="profile"><img src="/assets/images/faces/face5.jpg" alt="face5" /><span className="online"></span></div>
		                <div className="info">
		              ...
		              <li className="list">
		                <div className="profile"><img src="/assets/images/faces/face6.jpg" alt="face6" /><span className="online"></span></div>
		                <div className="info">
		                  <p>Sarah Graves</p>
		                  <p>Available</p>
		                </div>
